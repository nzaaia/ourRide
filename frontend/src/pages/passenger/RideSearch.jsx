...
export default function RideSearch() {
  const {
    data, role, acceptPassengerRide, makeCounterOffer, isAuthenticated,
    login, submitRideRequest, user, renterBookingRequests, activePassengerRides,
    cancelRideRequest
  } = useAuth();
        ...
        <div className="card ride-search__rider-card">
          <div className="ride-search__rider-header">
            {activeRide.counterOffer?.renterAvatar ? (
              <img src={activeRide.counterOffer.renterAvatar} alt={activeRide.counterOffer.renterName} className="ride-search__rider-avatar" />
            ) : (
              <div className="ride-search__rider-avatar-placeholder">🏍️</div>
            )}
            <div>
              <div className="ride-search__rider-name">{activeRide.counterOffer?.renterName || 'Your Rider'}</div>
          ...
          <div className="ride-search__fare-row">
            ...
            <span className="ride-search__fare-row-value">৳{activeRide.counterOffer?.fare || activeRide.estimatedFare}</span>
          </div>
